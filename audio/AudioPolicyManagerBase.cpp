...
AudioPolicyManagerBase::routing_strategy AudioPolicyManagerBase::getStrategy(
    ...
    case AudioSystem::VIDEO_TELEPHONY:
...
const AudioPolicyManagerBase::VolumeCurvePoint
    ...
    { // STRATEGY_MEDIA
        sHeadsetMediaVolumeCurve, //sDefaultMediaVolumeCurve, // DEVICE_CATEGORY_HEADSET
...
void AudioPolicyManagerBase::handleIncallSonification(int stream, bool starting, bool stateChange)
{
    ...
    if (getStrategy((AudioSystem::stream_type)stream) == STRATEGY_SONIFICATION) {
        ...
        if (outputDesc->mRefCount[stream]) {
            ...
            //modify by zhangku : notification emit beep when in-call
            //if (AudioSystem::isLowVisibility((AudioSystem::stream_type)stream)) {
            if (AudioSystem::SYSTEM == stream || AudioSystem::RING == stream) {
            //modify end
                ...
                if (starting) {
                    ...
                    if (stream == AudioSystem::NOTIFICATION) {
                        mpClientInterface->startTone(ToneGenerator::TONE_PROP_BEEP2, AudioSystem::VOICE_CALL);
                    } else {
                        mpClientInterface->startTone(ToneGenerator::TONE_SUP_CALL_WAITING, AudioSystem::VOICE_CALL);
                    }
                    //modify end
